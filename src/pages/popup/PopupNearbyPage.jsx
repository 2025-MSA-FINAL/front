...
function PopupNearbyPage() {
    ...
    }, [myLocation, searchCenter, searchRadiusKm]);

    // ===========================
    // 4. /nearby 조회 (검색 기준 중심+반경 기준)
    // ===========================
    useEffect(() => {
        ...
        <main className="min-h-[calc(100vh-88px)] px-4 py-6">
            <div className="max-w-6xl mx-auto flex flex-col gap-4">
                ...
                <section className="flex gap-4 h-[600px]">
                    {/* 사이드바 (리스트) */}
                    <aside
                        className={`bg-paper rounded-card shadow-card border border-secondary-light transition-all duration-300 overflow-hidden flex flex-col ${isSidebarOpen
                                ? "w-[360px] opacity-100"
