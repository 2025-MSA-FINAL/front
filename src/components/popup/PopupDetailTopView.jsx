    ...
    <>
      ...
      <div className="flex flex-col items-center gap-5 mb-10 text-center">
        ...
        <span
          className={`
            ...
            px-4 py-1.5 rounded-full border-[1.5px]
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12 items-start">
        ...
        <div className="flex flex-col h-full gap-6">
          <section className="bg-paper p-6 rounded-[20px] border border-secondary-light">
            <h2 className="text-[15px] font-bold text-text-black mb-3 flex items-center gap-2">
              ✨ AI 요약
            </h2>
            <p className="text-[14px] leading-7 text-text-sub whitespace-pre-line">
              {aiSummaryText}
            </p>
          </section>
          ...
          <section className="flex flex-col gap-4 py-2">
            ...
            <InfoRow
              label="가격"
              value={isFree ? "무료" : `${price?.toLocaleString()}원`}
            />
          </section>
